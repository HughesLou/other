...
def setup():
    ...
    scc.onpush_job = scc.jenkins.get_job('%s_onpush' % 'trunkbased_test')
    scc.create_jobs = scc.jenkins.get_job('%s_create-jobs' % 'trunkbased_test')
    scc.project_path = '/shared/opt/jenkins-home/master-repos/trunkbased_test'
